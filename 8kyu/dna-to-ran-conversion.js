...
four nucleic acid bases Guanine ('G'), Cytosine ('C'), Adenine ('A'), and Thymine ('T'). Ribonucleic acid, RNA, is 
the primary messenger molecule in cells. RNA differs slightly from DNA its chemical structure and contains no Thymine. 
...
console.log(DNA2('TTTT'));
console.log(DNA2('GCAT'));
console.log(DNA2('GACCGCCGCC'));