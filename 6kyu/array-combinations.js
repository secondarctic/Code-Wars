...
// Parameters : array, containing arrays as elements; nested arrays containing int, +; all array of varying lengths

// Return : return single int, +; representing total # of possible new, non-repeating combinations
...
/*
    function solve(arr) {
        // remove any duplicate entries from the incoming arrays
        // possible combinations will come from the number of unique choices in each nested array times all of the others
